...
7. svctool requires credentials for MySQL user 'admin' for the mysqldump option. You are encouraged to read [Setting MySQL Guide](https://github.com/mbhangui/indimail-virtualdomains/wiki/1-IndiMail#setting-up-mysql), on how to save MySQL credentials.
