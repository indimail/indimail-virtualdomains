...
1. add groups and users and home directory
    ...
    for the exact syntax. Also note that the exact value of uids, gids aren't important
    Note: You can skip this entire section and create the users in SECTION 3, STEP 4,
    by using the svctool command
