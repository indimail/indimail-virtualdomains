...
NOTE: The following clients use <u>/etc/indimail/control/defaultqueue</u> and $HOME/.defaultqueue - condredirect, dot-forward, fastforward, filterto, forward, maildirserial, new-inject, process_queue, qmail-inject, qmail-qread, qmail-showctl, qmta-send, qnotify, qreceipt, queue-fix, replier, rrforward, rrt.
